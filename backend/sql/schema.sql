-- Full database schema for NovaShop (run in phpMyAdmin)
...
-- Customer accounts (login stored in PHP session: $_SESSION['user'])
...
-- Business accounts (login stored in PHP session: $_SESSION['business'])
...
-- Products (linked to a business when created from the dashboard)
